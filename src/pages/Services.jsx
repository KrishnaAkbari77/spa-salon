...
const spaServices = [
  {
    ...
    title: "SPA & WELLNESS",
    img: imgSpaWellness,
    desc: "Holistic care encompassing body and mind.",
  },
  {
    id: 2,
    title: "FACIAL THERAPY",
    img: imgFacialTherapy,
    desc: "Targeted therapy to rejuvenate your facial features.",
  },
  {
    id: 3,
    title: "HOLISTIC MASSAGE",
    img: imgHolisticMassage,
    desc: "Balance your body's energy with our holistic approach.",
  },
  {
    id: 4,
    title: "HOT STONE MASSAGE",
    img: imgHotStone,
    desc: "Melt away tension with heated stones placed on key points.",
  },
];
...
const salonServices = [
  {
    id: 5,
    title: "HAIRCUTS, STYLING & COLORING",
    img: imgHaircuts,
    desc: "Expert haircuts, styling, and coloring including balayage and highlights.",
  },
  {
    id: 6,
    title: "HAIR TREATMENTS",
    img: imgHairTreatments,
    desc: "Revitalizing treatments like botox, keratin, and nano-plastia for healthy hair.",
  },
];
        ...
        <div className="services-list" style={{ paddingTop: "20px" }}>
          {spaServices.map((service, index) => (
            <div className="service-card" key={service.id}>
              <div
                className={`service-img ${index % 2 === 1 ? "order-last" : ""}`}
              >
